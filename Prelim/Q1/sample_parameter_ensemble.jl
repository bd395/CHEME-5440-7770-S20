...
function update_model_dictionary(parameter_array,default_model_dictionary)
	...
	#print(degradation_modifier_array)
	...
	#println(dilution_degradation_matrix)

    # return -
    return model_data_dictionary#, dilution_degradation_matrix
end
...
function main(path_to_ensemble_file::String, path_to_sim_dir::String; sample_fraction::Float64=1.0)
    ...
    for sample_index = 1:number_of_samples
		...
		#println(model_data_dictionary)
		#CSV.write(degradation_modifier_array_test,"test.csv")
		...
		#writedlm("$(path_to_sim_dir)/test.dat", degradation_modifier_array_test)

        # give user some notification -
        #@show sample_index

		#@show degradation_modifier_array_test
		#return degradation_modifier_array_test
    end
end


#print(degradation_modifier_array_test)
