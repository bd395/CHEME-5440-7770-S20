...
# Signal = 8e3
prob2_ea = ODEProblem(acdc!,u0, p = 105 ,tspan) # took S value from figue 2a #8e3
...
# S = 105 plot
# change p = 105 on line 91
S105ss = plot(sol2_ea[2:end], vars=(0,3), xaxis=("t"), yaxis=("Z",:log,(10^(-3),10^-1)), title="Z @ SS, S = 105", legend=false) #:log,(1e-3,10^-1))
display(S105ss)
#savefig(S105ss, "./2F_S_105ss.png")

# S = 100 plot
# comment line 114
# and uncomment line 115
